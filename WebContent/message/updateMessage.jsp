              ...
              <div class="col-lg-12">
				<form:form  action="update"  modelAttribute="messageVO">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" path="mes_text" id="mes_text" tabindex="1" value="${messageVO.mes_text}"/>
                  </div>
                    <form:input type="hidden" path="mes_no" id="mes_not" tabindex="1" value="${messageVO.mes_no}"/>
